Дана квадратная матрица и она задана в виде одномерного массива. Необходимо расчитать определитель для такой матрицы. Если вычислить определить нельзя, верните -404
